...
Given there is a signal file, the below summarises the categorical labels based on the calculated Categorical_Label of a Scar (count of 1's). What this means is the pool of data that can be fed into machine learning signficantly decreases.
```{r}
...
What do the signals look like? Click the Categories to highlight them
