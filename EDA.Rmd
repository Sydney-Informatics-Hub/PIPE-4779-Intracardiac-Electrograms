...
Affects 5 out of 23 thousand observations. Suspect Scar label to be misleading and Scar will be defined by biopsy layers.
...
Hence will refer to a Scar based on the biopsy layers as indication of scar
```{r}
